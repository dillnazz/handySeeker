...
//     try {
//       // Убедитесь, что email правильно введен
//       if (!email) {
//         setError("Пожалуйста, введите email.");
//         return;
//       }

//       // Указываем URL для перенаправления пользователя после завершения регистрации
//       const actionCodeSettings = {
//         url: "http://localhost:3000/complete-registration", // URL для завершения регистрации
...
//       // Сохраняем email для дальнейшего использования при завершении регистрации
//       window.localStorage.setItem("emailForSignIn", email);

//       setSuccess("Ссылка для подтверждения отправлена на ваш email.");
//     } catch (err) {
